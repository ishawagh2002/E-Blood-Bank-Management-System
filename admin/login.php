...
<style>
  body{
    background-image: url('admin_image/login_bg.jpg');
  }
</style>

</head>

<body style="background-size: 100% 100%; margin-left: 200px;">
  ...
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
      ...
      <div class="row justify-content-center">
          <div class="col-lg-6">
              <h1 class="mt-4 mb-3" style="color:red ;">
                  <b>E-Blood Bank Management Admin Login Portal</b>
                </h1>
            </div>
      </div>

      <center>
      <div class="card" style="height:250px; width: 550px; background-image:url('admin_image/glossy1.jpg'); ">
          <div class="card-body">
      <div class="row justify-content-lg-center justify-content-mb-center" >
      <div class="col-lg-6 mb-6 ">
      <div class="font-italic" style="font-weight:bold; text-align: left;">Username<span style="color:red">*</span></div>
    ...
    <div class="font-italic"style="font-weight:bold; text-align: left;">Password<span style="color:red">*</span></div>
