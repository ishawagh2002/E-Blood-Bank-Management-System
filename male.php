...
<div class="col-lg-4 mb-4">
<div class="font-italic"  >Weight in Kg</div>
<div><input type="number" name="weight" class="form-control"></div>
</div>
</div>
...
<div><select class="form-control" name="med" required>
<option value="">Select</option>
...
<div><select class="form-control" name="tat" required>
<option value="">Select</option>
<option value="Yes">Yes</option>
<option value="No">No</option>
</select>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $tat=$_POST['tat'];
        $haem=$_POST['haem'];
        if($age>=16 && $age<=60 && $weight>=50 && $weight<=90 && $med=='No' && $any=='No' && $haem>=12 && $tat=='No')
        {
