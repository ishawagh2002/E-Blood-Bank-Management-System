...
feed_number varchar(10) NOT NULL,
feed_mail varchar(50),
feed_like varchar(10) NOT NULL,
feed_improve varchar(10) NOT NULL,
feed_feedback varchar(100),
Primary key(feed_id)
);
...
values("mumabi,Maharashtra(001)","bloodbank@gmail.com","2344");
